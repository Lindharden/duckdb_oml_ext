...
#### Main build
# For regular CLI build, we link the oml extension directly into the DuckDB executable
...
#### Client tests
DEBUG_EXT_PATH='$(PROJ_DIR)build/debug/extension/oml/oml.duckdb_extension'
RELEASE_EXT_PATH='$(PROJ_DIR)build/release/extension/oml/oml.duckdb_extension'
